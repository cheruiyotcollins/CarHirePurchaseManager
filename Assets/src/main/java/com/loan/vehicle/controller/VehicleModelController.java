...
import com.loan.vehicle.dto.VehicleExist;
...
public class VehicleModelController {
 ...
 private static final Logger LOGGER = LoggerFactory.getLogger(VehicleService.class);
    ...
    @GetMapping("exist/{id}")
    public VehicleExist existById(@PathVariable long id) {
      VehicleExist vehicleExist= new VehicleExist();
      vehicleExist.existById=vehicleModelService.existById(id);
      LOGGER.info("*******Vehicle Exist? "+vehicleExist.toString());
        return vehicleExist;
